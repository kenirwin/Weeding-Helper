...
$innreach = array (
		   ...
		   "url" => "", // InnReach catalog url with no trailing slash, e.g. "https://olc1.ohiolink.edu"
		   "local_cat_url" => "", // local catalog url with no trailing slash, e.g. "https://ezra.wittenberg.edu"
