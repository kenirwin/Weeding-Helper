...
<p>
    <label for="userfile">File to upload</label>
			    <input name="userfile" type="file" id="userfile" class="upload" /> <span class="fieldnote">Must be less than 2.5 MB (~2000 records) <a href="documentation.php#how_to_add_circ_data" target="_new">See documentation for correct file format</a></span>
</p>

<p>
<label for="file_title">File title</label>
<input name="file_title" type="text" class="upload" />
